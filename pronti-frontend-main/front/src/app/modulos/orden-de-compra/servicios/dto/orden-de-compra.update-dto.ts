...
export interface OrdenDeCompraUpdateDto {
  ...
  observacion?: string;
  tipoVehiculo?: string;
  idProveedor?: ProveedorResponseDto | number;
  idContrato?: ContratoResponseDto | number;
  idArticulo?: ArticuloResponseDto | number;
}
