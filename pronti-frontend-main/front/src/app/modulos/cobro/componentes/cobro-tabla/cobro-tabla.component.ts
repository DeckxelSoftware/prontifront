...
@Component({
  selector: 'app-cobro-tabla',
  templateUrl: './cobro-tabla.component.html',
  styleUrls: ['./cobro-tabla.component.scss']
})
export class CobroTablaComponent extends AbstractTable<CobroResponseDto, CobroFindDto>
