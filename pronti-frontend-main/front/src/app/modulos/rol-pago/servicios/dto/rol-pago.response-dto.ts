...
import { HistoricoRolResponseDto } from '../../../historico-rol/servicios/dto/historico-rol.response-dto';

export interface RolPagoResponseDto extends AbstractResponseDto {
  // nombre?: string;
  horas25?: number;
  horas50?: number;
  horas100?: number;
  ...
  fechaHasta?: string;
  comision?: number;
  pagoDecimoCuartoMes?: number;
  prestamoQuirografario?: number;
  prestamoHipotecario?: number;
  idPeriodoLaboral?: PeriodoLaboralResponseDto;
  idHistorialLaboral?: HistorialLaboralResponseDto;
  idHistoricoRol?: any;
  utilidad?:number;
}
