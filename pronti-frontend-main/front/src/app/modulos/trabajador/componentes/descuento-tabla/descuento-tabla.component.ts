...
@Component({
  selector: 'app-descuento-tabla',
  templateUrl: './descuento-tabla.component.html',
  styleUrls: ['./descuento-tabla.component.scss']
})
export class DescuentoTablaComponent extends AbstractTable<TrabajadorResponseDto, TrabajadorFindDto>
