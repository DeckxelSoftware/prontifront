...
@Component({
  selector: 'app-licitacion-tabla',
  templateUrl: './licitacion-tabla.component.html',
  styleUrls: ['./licitacion-tabla.component.scss']
})
export class LicitacionTablaComponent extends AbstractTable<LicitacionResponseDto, LicitacionFindDto>
  implements OnInit, TableAbstractClass<LicitacionResponseDto>, AutocompleteFormInterface {
  searchBarFormFields: FormField[] = [
    {
      help: 'Puede buscar por nombre, identificación o número de contrato',
