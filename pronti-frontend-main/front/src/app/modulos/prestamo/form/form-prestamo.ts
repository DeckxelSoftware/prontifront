...
export const FORM_PRESTAMO: () => (FormField[]) = () => {
...
export const SELECT_ESTADO_PRESTAMO = {
  filterBy: 'estado',
  dataKey: 'estado',
  filterPlaceholder: 'Utilidades/Decimo cuarto,tercero/Rol',
  optionLabel: 'nombre',
  options: [
    {
      estado: 'PNT',
...
export const SELECT_MODALIDAD_DESCUENTO = {
  filterBy: 'modalidadDescuento',
  ...
  options: [
    ...
    {
      modalidadDescuento: 'UTL',
      nombre: 'Utilidades',
    },

    {
      modalidadDescuento: 'DCC',
      nombre: 'Décimo cuarto',
    },

    {
      modalidadDescuento: 'DCT',
