...
@Component({
  selector: 'app-cargo-vacacion-tabla',
  templateUrl: './cargo-vacacion-tabla.component.html',
  styleUrls: ['./cargo-vacacion-tabla.component.scss']
})
export class CargoVacacionTablaComponent extends AbstractTable<CargoVacacionResponseDto, CargoVacacionFindDto>
  ...
  irARegistroVacaciones(registro: any) {
    // /personal/trabajadores-modulo/1/cargo-vacacion-modulo/1/registro-vacacion-modulo/registro-vacacion
    const {idTrabajador} = this.activatedRoute.snapshot.params;
    this._router.navigate([
      'personal',
      'trabajadores-modulo',
      idTrabajador,
      'cargo-vacacion-modulo',
      registro.id,
