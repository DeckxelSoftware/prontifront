...
import {FORM_INGRESO_ENUM} from '../../form/form-ingreso.enum';
import {FORM_INGRESO} from '../../form/form-ingreso';

@Component({
  selector: 'app-ingreso-tabla',
  templateUrl: './ingreso-tabla.component.html',
  styleUrls: ['./ingreso-tabla.component.scss']
})
export class IngresoTablaComponent  extends AbstractTable<TrabajadorResponseDto, TrabajadorFindDto>
